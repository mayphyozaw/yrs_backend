...
@section('content')
    <x-card>
        ...
        <form method="post" action="{{ route('route.store') }}" class="tw-mt-6 tw-space-y-6 tw-text-sm repeater"
            id="submit-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <x-text-input name="title" type="text" class="tw-mt-1 tw-block tw-w-full" :value="old('title')" />
            </div>
            ...
            <div class="form-group">
                ...
                <select name="direction" class="custom-select">
                    <option value="clockwise" @if (old('direction') == 'clockwise') selected @endif>
                        Clockwise
                    </option>
