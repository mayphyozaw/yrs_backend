@extends('layouts.app')
@section('title', 'Reduce Amount Wallet')
...
@section('header')
    <div class="tw-flex tw-justify-between tw-items-center">
        <div class="tw-flex tw-justify-between tw-items-center">
            ...
            <h5 class="tw-text-lg mb-0">Reduce Amount Wallet</h5>
        </div>
...
@section('content')
    <x-card>
        ...
        <form method="post" action="{{ route('wallet-reduce-amount.store') }}" class="tw-mt-6 tw-space-y-6 tw-text-sm" id="submit-form">
            @csrf
